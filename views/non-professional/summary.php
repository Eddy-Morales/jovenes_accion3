...
<div class="max-w-4xl mx-auto">
    <div class="glass rounded-3xl p-12 shadow-2xl border border-white/50 relative overflow-hidden text-center animate-fade-in-up">
        ...
        <div class="mb-10">
            <div class="h-24 w-24 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner ring-8 ring-green-50 animate-bounce-slow">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="../../actions/generate_word.php" target="_blank" onclick="handleDownload()" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-bold rounded-xl text-white btn-premium shadow-lg hover:shadow-indigo-500/30 transform hover:-translate-y-1 transition-all">
...
function handleDownload() {
    // Wait for the download to initiate (approx 1.5s), then redirect
    // Use setTimeout to allow the browser to process the download request first
    setTimeout(() => {
        window.location.href = '../../dashboard.php?tab=reports&msg=completed';
    }, 1500);
}
</script>
